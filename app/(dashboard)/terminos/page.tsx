  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-3xl">
      <article className="prose prose-sm sm:prose-base lg:prose-lg prose-blue max-w-none dark:prose-invert">
        ...
        <p>
          Bienvenido/a a {appName} (el "Servicio"), operado por {companyName}{' '}
          ("Nosotros"). Estos Términos y Condiciones ("Términos") rigen tu
          acceso y uso del Servicio. Al registrarte, acceder o utilizar nuestro
          Servicio, confirmas que has leído, entendido y aceptado estar
          vinculado por estos Términos y nuestra{' '}
          <Link href={privacyPolicyUrl}>Política de Privacidad</Link>. Si no
          estás de acuerdo con alguno de estos términos, no debes utilizar el
          Servicio.
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            como tal actúa como "Propietario" (Owner). El Propietario puede
            invitar a otros usuarios como "Colaboradores" (ej: Admin, Editor)
            asignándoles roles con diferentes niveles de acceso y permisos,
            según se describa en la documentación o interfaz del Servicio. El
            Propietario del Negocio es responsable final de la gestión de sus
            Colaboradores y del uso que estos hagan del Servicio.
          </li>
          <li>
        ...
        <ol>
          <li>
            ...
            clientes, recetas, pedidos, etc.) ("Contenido del Usuario").
          </li>
          <li>
        ...
        <p>
          ...
          garantizamos que el Servicio sea ininterrumpido, seguro, libre de
          errores o que satisfaga todas tus necesidades específicas.
        </p>
