    ...
    <div className="container mx-auto px-4 py-8 md:py-12 max-w-3xl">
      <article className="prose prose-sm sm:prose-base lg:prose-lg prose-blue max-w-none dark:prose-invert">
        ...
        <p>
          ...
          Esta Política de Privacidad explica cómo {companyName} ("nosotros",
          "nuestro") recopila, utiliza, comparte y protege tu información
          personal cuando utilizas nuestra aplicación web y servicios
          relacionados (el "Servicio"), accesible desde {websiteUrl}.
        </p>
        <p>
        ...
        <p>
          ...
          página y actualizando la "Fecha de Entrada en Vigor". Te recomendamos
